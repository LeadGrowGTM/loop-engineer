...
- Every implementation edit is traceable to one explicitly approved C01-C10 decision, one observable phase, one issue slice, and one commit.
...
- Adjacent cleanup, publishing, new external dependencies, treehouse redesign beyond approved C09, or changes outside C01-C10.
