...
```bash
bun C:\Users\mitch\Everything_CC\agent-harness\scripts\setup-harness.ts install <repo-root>
```
...
```bash
bun C:\Users\mitch\Everything_CC\agent-harness\scripts\setup-harness.ts smoke <repo-root> ~/.claude/agents
```
...
- Script: `agent-harness/scripts/setup-harness.ts`
